...
public:
    ...
    virtual void connect_tcp(const String &host,
            const String &service, double timeout_sec = 100)
    {
    ...
    virtual Object nvim_call_function (const String& fname, const Array& args)
    {

        Object res;
        client_.call("nvim_call_function", res, fname, args);
        return res;
    ...
    virtual void ui_detach ()
    {

        client_.call("ui_detach", nullptr);

    }

    virtual Object ui_try_resize (Integer width, Integer height)
    {
    ...
    virtual Object vim_call_function (const String& fname, const Array& args)
    {

        Object res;
        client_.call("vim_call_function", res, fname, args);
        return res;
    ...
    virtual void vim_subscribe (const String& event)
    {
    ...
    virtual void vim_unsubscribe (const String& event)
    {
